...
;(function($){
  ...
  var $controller, $component, $views, $buttons;
  ...
  var onClick = function onClick(evt) {
    ...
    toggleViews($target.data().view);
    $target.toggleClass('active');
  }

  // listen for mouse events
  
  var onMouse = function onMouse(evt) {
    switch(evt.type) {
      case 'mouseenter':
        $controller.toggleClass('active', true);
        break;
      case 'mouseleave':
        $controller.toggleClass('active', false);
        break;
    }
  };

  // listen for changes to toggle position
  ...
  var bindToView = function bindToView() {
    $views.each(function() {
      var $view = $(this);
      $('.grid-overlay', $view).css({ height: $view.height() });
    });
  };
  ...
  var init = function init() {
    ...
    $component = $('.component')
      .on('mouseenter mouseleave', onMouse)
